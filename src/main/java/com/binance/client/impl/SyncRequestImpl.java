...
import com.binance.client.model.user.UserDataRisk;
...
public class SyncRequestImpl implements SyncRequestClient {
    ...
    @Override
    public List<PositionRisk>  getUserDataRisk(String symbol) {
        return RestApiInvoker.callSync(requestImpl.getUserDataRisk(symbol));
    }
    ...
    @Override
    public List<AccountBalance> userBalance() {
        return RestApiInvoker.callSync(requestImpl.userBalance());
    }
